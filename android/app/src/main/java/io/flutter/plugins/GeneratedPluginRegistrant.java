...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.superwall.superwallkit_flutter.SuperwallkitFlutterPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin superwallkit_flutter, com.superwall.superwallkit_flutter.SuperwallkitFlutterPlugin", e);
    }
    try {
